...
<body>
	...
	<br><br>
	<a href="login.htm">Patient Home</a>
	...
	$("#proc").change(function(){
		...
		$.post( "getProcDoc.htm", { procId:$("#proc").val()},function(data){
			...
			$('<br><br><label>Input Date: </label><input name="date1" id="date1" type="date" min="'+(currentDate.toISOString().slice(0, 10))+'" max="'+(maxDate.toISOString().slice(0, 10))+'" />').appendTo("#div1").change(function(){
